...
public class GeometricBodyController {
    //public List <GeometricBody> GemetricBodyControllerList = new ArrayList<>();
    public List <GeometricBodyInterface> GemetricBodyControllerList = new ArrayList<>();

    /*public GeometricBodyController(List<GeometricBody> GBCL){
        GemetricBodyControllerList = GBCL;
    }*/

    public GeometricBodyController(List<GeometricBodyInterface> GBCL){
        GemetricBodyControllerList = GBCL;
    }
